...
int moodycamel_cq_enqueue(MoodycamelCQHandle handle, MoodycamelCQValue value)
{
	if (handle == nullptr) {
		return 0;
	}
...
int moodycamel_cq_try_dequeue(MoodycamelCQHandle handle, MoodycamelCQValue* value)
{
	if (handle == nullptr) {
		return 0;
	}
